...
import com.ta.bank.customer.strategy.CustomerAddressAggregationStrategyImpl;
import com.ta.bank.customer.strategy.CustomerAggregationStrategyImpl;
import com.ta.common.bean.Address;
...
public class CamelPullingData extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("direct:customer").setBody().constant(null).to("netty4-http:http//localhost:8282/customer/1")
